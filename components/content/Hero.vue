  ...
  <div class="relative isolate px-6 pt-14 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      <div class="text-center">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-600">{{ props.subtitle }}</p>
      </div>
      <div class="hidden sm:mt-8 sm:flex sm:justify-center">
        <div
          class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
          <a href="https://mth-metatoul.com/" target="_blank" class="font-semibold text-indigo-600">MetaToul website</a>
        </div>
      </div>
    </div>
    <div
